...
import static eg.com.cat.janssen.view.LoginActivity.currentuser;
...
public class SwipeController extends Callback {
    ...
    public AllDoctorsResponseModel postsResponseModel;
    ...
    public SwipeController(AllDoctorsResponseModel postsResponseModel, SwipeControllerActions buttonsActions) {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (postsResponseModel.getData().get(position).getUser_id()
